...
var require_lib4 = __commonJS({
  "src/lib.js"(exports) {
    ...
    function setTextOutputs2(o) {
      Object.keys(o).forEach((k) => {
        core2.setOutput(k, o[k].join("\n"));
      });
    }
    exports.setTextOutputs = setTextOutputs2;
    function getSHAs() {
      const compareURL = github2.context.payload.compare;
      ...
      core2.setFailed(`Could not determine commit SHAs from compare URL: ${compareURL}`);
      return process.exit();
    }
    ...
    async function gitDiff(before, after) {
      ...
      core2.debug(`Raw output:
${output}`);
      return output;
    }
    exports.gitDiff = gitDiff;
    async function getChangesViaGit([before, after] = getSHAs()) {
      core2.debug(`Before SHA: ${before}`);
      core2.debug(`After SHA: ${after}`);
    ...
    async function getChanges2() {
      return github2.context.eventName.startsWith("pull_request") ? getChangesViaAPI() : getChangesViaGit();
    }
    exports.getChanges = getChanges2;
  }
});
